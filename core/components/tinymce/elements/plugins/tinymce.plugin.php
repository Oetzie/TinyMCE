...
if (in_array($modx->event->name, ['OnManagerPageBeforeRender', 'OnRichTextEditorRegister', 'OnRichTextEditorInit', 'OnRichTextBrowserInit', 'OnTVInputRenderList', 'OnTVInputPropertiesList', 'OnClientSettingsRegisterSettings'], true)) {
